...
/**
 * <p>
 * Manages calendar events, including adding, updating, checking for duplicates, and
...
public class CalenderEventManager implements CalendarEvent {
  ...
  public boolean checkForDuplicates(Event event) {
    ...
    for (Event e : events) {
      ...
      if (start != null && end != null && start2 != null && end2 != null) {
        if (!(end.isBefore(start2) || start.isAfter(end2))) {
          return true;
        }
      }
      ...
      if (start != null && repeatDt != null && start2 != null && repeatDt2 != null) {
        if (!(repeatDt.isBefore(start2) || start.isAfter(repeatDt2))) {
          return true;
        }
      }

      // **Case 3: All-day event overlaps**
      if ((allDay != null && allDay.equals(allDay2)) || (allDay != null && repeat2 != null
              && allDay.equals(repeat2))) {
        return true;
      }

      // **Case 4: RepeatDate overlaps**
      if ((repeat != null && repeat.equals(repeat2)) || (repeat != null && allDay2 != null
              && repeat.equals(allDay2))) {
        return true;
      }

      // **Case 5: RepeatDateTime overlaps another event's time**
      if (repeatDt != null && start2 != null && end2 != null) {
        if (!(repeatDt.isBefore(start2) || repeatDt.isAfter(end2))) {
          return true;
        }
      }

      // **Case 6: RepeatDateTime exact match**
      if (repeatDt != null && repeatDt2 != null && repeatDt.equals(repeatDt2)) {
        return true;
      }
  ...
  public List<Map<String, Object>> getEventForDisplay(LocalDateTime startTime,
    ...
    LocalDate endDate = (endTime != null) ? endTime.toLocalDate() : null;

    List<Event> eventList = events.stream()
            .filter(e -> e.getStartDateTime() != null || e.getEndDateTime() != null
                    || e.getAllDate() != null || e.getRepeatDate() != null
                    || e.getRepeatDateTime() != null)
            .filter(e ->
                    (e.getStartDateTime() != null &&
                            (e.getStartDateTime().isEqual(startTime)
                                    || e.getStartDateTime().isAfter(startTime)))
                            && (e.getEndDateTime() != null &&
                            (endTime == null || e.getEndDateTime().isEqual(endTime)
                                    || e.getEndDateTime().isBefore(endTime)))
                            || (e.getAllDate() != null &&
                            (startDate != null && (e.getAllDate().isEqual(startDate)
                                    || e.getAllDate().isEqual(endDate) ||
                                    (e.getAllDate().isAfter(startDate)
                                            && e.getAllDate().isBefore(endDate)))))
                            || (e.getRepeatDate() != null &&
                            (startDate != null && (e.getRepeatDate().isEqual(startDate)
                                    || e.getRepeatDate().isEqual(endDate)
                                    || (e.getRepeatDate().isAfter(startDate)
                                    && e.getRepeatDate().isBefore(endDate)))))
                            || (e.getRepeatDateTime() != null
                            && (startTime != null && (e.getRepeatDateTime().isEqual(startTime)
  ...
  public List<Map<String, Object>> getEventForDisplay(LocalDate startDate, LocalDate endDate) {
    ...
    return getEventDetails(filteredEvents);
  }
  ...
  public List<Map<String, Object>> getEvents() {
    ...
    for (Event event : events) {
      ...
      if (startDateTime != null) {
        ...
        LocalDate allDate = event.getAllDayEnd();
        if (allDate != null) {
          eventDetails.put(EventKeys.ALLDAY_DATE, allDate);
        }
      }
      LocalDateTime endDateTime = event.getEndDateTime();
      if (endDateTime != null) {
        ...
        LocalDate repDate = event.getRepeatDate();
        if (repDate != null) {
          eventDetails.put(EventKeys.REPEAT_DATE, repDate);
        }
