...
public class ControllerEditCommandTest {
  ...
  public void testExecute_editSingleEvent() {
    String create = "create event Team Meeting from 2025-03-25T10:00 to 2025-03-25T12:00" +
    ...
    String command = "edit event location Event2 from 2025-03-25T10:00 to 2025-03-25T12:00" +
            " with New Location";
  ...
  public void testExecute_editMultipleEventsWithStartTime() {
    String create = "create event title Conference from 2025-03-25T14:00 to 2025-03-25T17:00 " +
            "location Old Location";
    controllerCreateCommand.execute(create);
    Map<String, Object> eventDes = CalendarFactory.getModel().getEventsForDisplay().get(0);
    ...
    String command = "edit events location title Conference from 2025-03-25T14:00 with" +
            " New Location";
  ...
  public void testExecute_editMultipleEventsWithoutTime() {
    String create = "create event title1 from 2025-03-25T14:00 to 2025-03-25T17:00 location" +
            " Old Location";
    controllerCreateCommand.execute(create);
  ...
  public void testExecute_invalidDateTimeFormat() {
    ...
    String command = "edit event title Team Meeting from 2025-03-25T10:00 to invalid-date with " +
            "New Location";
